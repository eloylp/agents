	...
	if deps.Fleet != nil {
		...
		srv.AddTool(
			mcpgo.NewTool("create_agent",
				...
				mcpgo.WithString("prompt",
					mcpgo.Description("Legacy inline prompt body. Prefer prompt_ref for global prompt catalog references."),
				),
				mcpgo.WithString("prompt_ref",
					mcpgo.Description("Global prompt name to reference from this workspace-local agent."),
				),
		...
		srv.AddTool(
			mcpgo.NewTool("update_agent",
				...
				mcpgo.WithString("prompt",
					mcpgo.Description("Legacy inline prompt body. Prefer prompt_ref. Omit to leave unchanged."),
				),
				mcpgo.WithString("prompt_ref",
					mcpgo.Description("Global prompt name. Omit to leave unchanged."),
				),
				mcpgo.WithString("scope_type",
