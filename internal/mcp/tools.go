	...
	if deps.Fleet != nil {
		...
		srv.AddTool(
			mcpgo.NewTool("create_skill",
				...
				mcpgo.WithString("id",
					mcpgo.Description("Stable public skill id. Required when creating a new skill; omit only to update an existing same-scope/name skill."),
				),
				mcpgo.WithString("workspace_id",
		...
		srv.AddTool(
			mcpgo.NewTool("create_prompt",
				...
				mcpgo.WithString("id",
					mcpgo.Description("Stable public prompt id. Required when creating a new prompt; omit only to update an existing same-scope/name prompt."),
				),
				mcpgo.WithString("workspace_id",
		...
		srv.AddTool(
			mcpgo.NewTool("create_guardrail",
				...
				mcpgo.WithString("id",
					mcpgo.Description("Stable public guardrail id. Required when creating a new guardrail; omit only to update an existing same-scope/name guardrail."),
				),
				mcpgo.WithString("workspace_id",
