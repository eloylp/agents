...
- **Daemon auth**: create the first local admin user in the dashboard, use an `HttpOnly` browser session for UI access, manage additional users, and create revocable named bearer tokens for MCP/API clients.
