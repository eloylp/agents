...
ARG RUNNER_BASH_VERSION=~5.3
ARG RUNNER_BUILD_BASE_VERSION=~0.5
ARG RUNNER_CA_CERTIFICATES_VERSION=~20260413
ARG RUNNER_CARGO_VERSION=~1.91
ARG RUNNER_CURL_VERSION=~8
ARG RUNNER_GIT_VERSION=~2.52
ARG RUNNER_GITHUB_CLI_VERSION=~2.83
ARG RUNNER_GO_VERSION=~1.25
ARG RUNNER_JQ_VERSION=~1.8
ARG RUNNER_RUST_VERSION=~1.91
